...
after the adapter validates Herdr schema 1, qualified protocol 19, 20, or 21, or the
single provisional protocol 22, and the semantic prompt contract. Its `Live in
