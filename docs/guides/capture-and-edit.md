...
surprising boundaries. Undo is the safe response when the previewed unit was
not intended.
...
Press ++slash++ in Board mode. Search covers thought content and keeps the board
