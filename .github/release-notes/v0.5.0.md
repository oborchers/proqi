...
Local storage schema and storage protocol 11 add durable thought-transformation
operations. Schema 10 added semantic shortcut emphasis, and owner-control
protocol 7 carries the current update boundary. Supported older stores migrate
automatically after backup and lease acquisition. Older active owners are not
declared compatible with operation or annotation variants they cannot decode.
