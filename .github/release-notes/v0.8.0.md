...
- `Reflow thought in place` recovers prose pasted exactly by mistake. Board `f`
  targets the focused thought; Edit `Primary+F` targets the complete active
  ...
  is one undoable history step. Repeating a normalized result creates no entry.
