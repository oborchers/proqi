...
impl ShortcutActionId {
    ...
    pub(crate) const COMMANDS: [(Self, &'static str); 58] = [
        ...
        (Self::Delete, "Delete item or selection"),
        (Self::Copy, "Copy thought text"),
        (Self::Cut, "Cut thought text"),
        ...
        (Self::Undo, "Undo"),
        (Self::Redo, "Redo"),
        (Self::MoveUp, "Move item up"),
        (Self::MoveDown, "Move item down"),
        (Self::FocusFirst, "Go to first thought"),
        (Self::FocusLast, "Go to last thought"),
        (Self::Collapse, "Expand or collapse thought"),
        (Self::Select, "Toggle item selection"),
    ...
    pub const fn diagnostics_id(self) -> &'static str {
        ...
        match self {
            ...
            FocusFirst => "board.first_thought",
            FocusLast => "board.last_thought",
            ExtendFirst => "board.range_first_thought",
            ExtendLast => "board.range_last_thought",
            ...
            InsertAbove => "thought.insert_above",
            InsertBelow => "thought.insert_below",
            InsertSeparator => "board.insert_separator",
